...
const SimpanKeBlockchain = () => {
  ...
  const fetchBlockchainData = async () => {
    try {
      const response = await axios.get('https://fabric-ternak-backend.my.to/TernakSapi');
      ...
      if (result.isConfirmed) {
        try {
          const sapiStringified = {
            ...
            beratAwal: sapi.beratAwal,
            umurMasuk: sapi.umurMasuk,
            beratSekarang: sapi.beratSekarang,
            umurSekarang: sapi.umurSekarang,
          ...
          setIsLoading(true);
          const response = await axios.post('https://fabric-ternak-backend.my.to/simpan', sapiStringified);
